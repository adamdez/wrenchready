        ...
        <div className="shell grid gap-10 py-16 md:grid-cols-2 xl:grid-cols-4">
          <div className="space-y-5">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-[var(--wr-teal)]/40 bg-[var(--wr-teal)]/10 px-4 py-2.5 text-sm font-semibold text-[var(--wr-teal-soft)] transition-colors hover:bg-[var(--wr-teal)]/20"
            >
