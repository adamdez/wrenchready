...
const toolHandlers: Record<string, (payload: unknown) => Promise<unknown>> = {
  ...
  lookup_vehicle_spec: lookupVehicleSpec,
  record_vehicle_spec: recordVehicleSpec,
  ...
  prepare_quote_draft_for_review: prepareQuoteDraftForReview,
  ...
  check_stripe_payment_status: checkStripePaymentStatus,
  sync_jeff_calendar: syncJeffCalendar,
  sync_jeff_gmail_inbox: syncJeffGmailInbox,
  prepare_parts_cart: preparePartsCartForSimon,
